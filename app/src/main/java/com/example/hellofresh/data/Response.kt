...
/**
 * This data class defines list of recipes after json parsing.
 */
//data class HelloFreshResults(val items: List<Recipe>)
...
/**
 * This is temporary code. Will be replace by the data from JSON file
 */
val testDataList =
    listOf(
    ...
    Recipe(name = "Simple Sumptuous Sea Bream", difficulty = 2, id = "1123")
    )
...
val recipeList: List<Recipe> = gson.fromJson(jsonArrayString, recipeListType)
